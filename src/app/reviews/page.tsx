...
export default function ReviewsPage() {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-12 md:py-16">
      ...
      <p className="mt-4 text-brand-black/80 leading-relaxed">
        Thank you for choosing <span className="font-bold">{site.name}</span>!
        It was an honor serving your electrical needs. Your feedback is valuable
        - please consider leaving a review on any of the following platforms.
      </p>
        ...
        {platforms.map((p) => {
          ...
          return (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-2xl border border-brand-black/10 p-6 hover:bg-black/5 flex items-center gap-4 transition-colors duration-200"
            >
              <div className="flex-shrink-0">
                <IconComponent className={`${iconSize} text-brand-yellow`} />
              </div>
              <div>
                <p className="font-bold text-brand-black">{p.name}</p>
